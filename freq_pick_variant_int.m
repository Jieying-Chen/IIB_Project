...
if save_key == 1
    ...
    str = "C:\Users\96326\Desktop\IIBproject\IIB_Project\MATLAB_data\" + name1 + "var3.mat";
    save(str,"key");
end
...
if save_int == 1
    ...
    str2 = "C:\Users\96326\Desktop\IIBproject\IIB_Project\MATLAB_data\" + name2 + "var3.mat";
